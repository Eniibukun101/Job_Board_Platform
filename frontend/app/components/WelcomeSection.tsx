...
export default function WelcomeSection() {
  return (
    <div className="hidden md:flex md:w-[52%] flex-col items-center justify-center px-12 relative bg-white">
      {/* Logo */}
      <div className="absolute top-8 left-8">
        <Image src="/logo.jpeg" alt="Jobnest Logo" width={140} height={140} className="rounded-lg" />
      </div>
