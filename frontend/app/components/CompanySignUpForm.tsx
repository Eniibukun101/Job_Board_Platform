...
export default function CompanySignUpForm() {
  ...
  return (
    <>
      <h2 className="text-2xl md:text-3xl font-bold text-primary mb-2">Register Now!</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <div className="relative">
            <span className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400">
              <Image src="/companynameicon.jpeg" alt="Company" width={16} height={16} />
            </span>
            <input
              id="company"
              value={companyName}
        ...
        <div>
          ...
          <div className="relative">
            <span className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400">
              <Image src="/passwordicon.jpeg" alt="Password" width={16} height={16} />
            </span>
            <button
              type="button"
        ...
        <div>
          ...
          <div className="relative">
            <span className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400">
              <Image src="/passwordicon.jpeg" alt="Confirm" width={16} height={16} />
            </span>
            <button
              type="button"
      ...
      >
        <img src="https://upload.wikimedia.org/wikipedia/commons/c/c1/Google_%22G%22_logo.svg" alt="Google Icon" className="w-5 h-5" />
        Continue with Google
      </button>

      <p className="text-center text-gray-600 text-sm mt-6">
        Already registered? <Link href="/employer" className="text-accent font-semibold hover:underline">Sign in</Link>
      </p>
    </>
  )
}
