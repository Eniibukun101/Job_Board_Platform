      ...
      <section className="mx-auto flex min-h-[calc(100vh-2rem)] w-full max-w-[1440px] overflow-hidden rounded-[18px] bg-[#20212b] md:min-h-[calc(100vh-3.5rem)]">
        <div className="hidden w-[52%] flex-col justify-center bg-[#20212b] px-14 py-12 text-white lg:flex xl:px-20">
          ...
          <div className="mt-16 max-w-[520px]">
            ...
            <p className="mt-5 max-w-[500px] text-base leading-6 text-gray-100">
              Access a growing network of talented candidates ready to help your company succeed.
            </p>
          </div>
        </div>
        ...
        <div className="flex w-full items-center bg-white px-8 py-16 lg:w-[48%] lg:rounded-l-[64px] lg:px-12 xl:px-16">
          <div className="mx-auto w-full max-w-[520px]">
            <h2 className="text-2xl font-extrabold text-black md:text-3xl">Tell us more about</h2>
            <p className="mt-5 text-sm text-gray-500">Let us get to know your company</p>

            <form className="mt-8 space-y-6">
              <div>
                <label htmlFor="industry" className="mb-2 block text-base font-bold text-black">
                  Industry
                </label>
                <input
                  id="industry"
              ...
              <div>
                <label htmlFor="website" className="mb-2 block text-base font-bold text-black">
                  Website Url
                </label>
                <input
                  id="website"
                  type="url"
                  placeholder="e.g http/signup/ng"
                  className="h-11 w-full rounded-[9px] border border-[#1f2430] px-4 text-sm text-gray-900 outline-none placeholder:text-[11px] placeholder:font-semibold placeholder:text-gray-500 focus:border-accent"
                />
              </div>

              <div>
                <label htmlFor="location" className="mb-2 block text-base font-bold text-black">
                  Location
                </label>
                <input
                  id="location"
              ...
              <div className="flex items-center justify-between gap-4 pt-5">
                ...
                <Link
                  href="/employer"
                  className="flex h-10 min-w-[112px] items-center justify-center rounded-full bg-[#20212b] px-6 text-sm font-semibold text-white transition-colors hover:bg-[#2c2d39]"
                >
                  Continue
                </Link>
              </div>
